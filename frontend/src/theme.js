...
//allows us to create context so we have access to the condition of whether it is dark or light and provides function to change this
...
export const useMode = ()=>{
    ...
    const colourMode = useMemo(
        ()=>({
            //functionality to alter light dark mode
            toggleColourMode: ()=>
